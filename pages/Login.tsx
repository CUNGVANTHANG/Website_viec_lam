...
export const Login: React.FC<LoginProps> = ({ onLogin }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      if (email.includes('employer')) role = Role.EMPLOYER;
      if (email.includes('admin')) role = Role.ADMIN;
      ...
      else if (role === Role.EMPLOYER) navigate('/employer');
    ...
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-2xl shadow-xl border border-gray-100">
        <div className="text-center">
          <div className="mx-auto h-12 w-12 bg-primary-600 rounded-xl flex items-center justify-center text-white mb-4">
        ...
        <div className="mt-4 bg-blue-50 p-4 rounded-lg text-xs text-blue-800 border border-blue-100">
           <p className="font-bold mb-1">Tài khoản Demo:</p>
           <ul className="list-disc pl-4 space-y-1">
             <li>Ứng viên: bất kỳ email nào</li>
             <li>Nhà tuyển dụng: email chứa "employer"</li>
             <li>Admin: email chứa "admin"</li>
           </ul>
        </div>
      </div>
    </div>
